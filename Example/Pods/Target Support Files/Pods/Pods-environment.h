...
// MLAudio
#define COCOAPODS_POD_AVAILABLE_MLAudio
#define COCOAPODS_VERSION_MAJOR_MLAudio 1
#define COCOAPODS_VERSION_MINOR_MLAudio 0
#define COCOAPODS_VERSION_PATCH_MLAudio 0
