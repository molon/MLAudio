...
#define kDataCacheDirName @"MLDataCache"
...
- (NSString*)filePathForKey:(NSString*)key
{
    ...
    NSString *cacheDir = [paths[0] stringByAppendingPathComponent:kDataCacheDirName];
    ...
    return [cacheDir stringByAppendingPathComponent:[MLDataCache md5String:key]];
}
